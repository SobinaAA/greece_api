...
import { EntitiesApi, MythologyGetCategoryEnum, MythologyGetSortEnum, MythologyEntity, MythologyIdPatchRequest } from "../clients";
...
export class EntitiesService {
  ...
  async update(id: number, entity: MythologyEntity, expectedStatus?: number) {
    return this.request(() => this.api.mythologyIdPut(id, entity), expectedStatus);
  }

  async patch(id: number, entity: MythologyIdPatchRequest, expectedStatus?: number) {
    return this.request(() => this.api.mythologyIdPatch(id, entity), expectedStatus);
  }

  async delete(id: number, expectedStatus?: number) {
